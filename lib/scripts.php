...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/style-dev.css', false, '6c39f42987ae297a5a21e2bb35bf3402');
  ...
  if (!is_admin() && current_theme_supports('jquery-cdn')) {
    ...
    wp_register_script('jquery', get_template_directory_uri() . '/assets/js/vendor/jquery-1.10.2.min.js', false, null, false);
  ...
  wp_register_script('foundation', get_template_directory_uri() . '/assets/js/vendor/foundation.min.js', false, null, true);
